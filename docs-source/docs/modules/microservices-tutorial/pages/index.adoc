...
=== Akka Workshop
In addition to the above resources there is the video based https://info.lightbend.com/akka-platform-workshop-part-1-on-demand-recording.html[Akka Workshop Series {tab-icon}, window="tab"]. The series will walk you through the basics of using the Akka in parallel with much of the material in this guide. It should be especially useful for individuals who are audio/visual learners.
