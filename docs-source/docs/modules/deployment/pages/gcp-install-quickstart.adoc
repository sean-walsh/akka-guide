...
NOTE: Pulumi has an issue with tracking ready status for containers with sidecars. In GCP implementation of the Akka Operator, Usage-based Billing Agent (ubbagent)
